...
That emptiness is itself the trigger: `AGENTS.md`'s first-time-setup gate
...
**Skills:** <.Codex/skills/* the task-implementer should load>
...
Fix what's found before asking for approval. Don't make the user do Codex's
proofreading.
...
- Keep this template's locked stack defaults unless the user explicitly asks
  to change them (see `AGENTS.md` Stack section) — Phase 0 fills in the
