---
name: "source-command-next-layer"
description: "Gate the current layer on all tests passing, then advance tasks/done.md, create the next layer file, and bump Current Layer in AGENTS.md."
---

# source-command-next-layer

Use this skill when the user asks to run the migrated source command `next-layer`.
...
4. **Bump `AGENTS.md`.** Update the "Current Layer" / "Current Task"
