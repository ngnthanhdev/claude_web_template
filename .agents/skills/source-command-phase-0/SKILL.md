...
# source-command-phase-0

Use this skill when the user asks to run the migrated source command `phase-0`.
...
approved design for what's being asked. Per `AGENTS.md`'s first-time-setup
