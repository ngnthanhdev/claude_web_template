...
export const envSchema = environmentObjectSchema.superRefine((environment, context) => {
  ...
  if (
    ...
    context.addIssue({
      code: z.ZodIssueCode.custom,
      message: "PUBLIC_WEB_ORIGIN must be an HTTPS origin (loopback HTTP is development-only)",
